...
public class SignatureHashAndKeyLengthProbe extends SimpleProbe {
    ...
    public SignatureHashAndKeyLengthProbe(
    ...
    protected X509CertificateChainConfig prepareConfig() {
        ...
        if (entity) {
            ...
            CachedKeyPairGenerator.generateNewKeys(
                    signatureHashAlgorithmKeyLengthPair, signerConfig, "inter0");
            entityConfig.setSignatureAlgorithm(
    ...
    protected ProbeResult createResult(VerifierResult verifierResult) {
        return new SignatureAlgorithmProbeResult(
                signatureHashAlgorithmKeyLengthPair, verifierResult.isValid());
    }
}
