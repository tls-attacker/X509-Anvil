...
public class CommonConstraints {
    public static <T> FlexibleConditionalConstraint valuesOnlyAllowedInV3Certs(
    ...
    public static <T> FlexibleConditionalConstraint valuesNotAllowedForVersions(
        ...
        return ValueRestrictionConstraintBuilder.<T>init(
                        "Extensions may only be present in v3 certificates", derivationScope)
                .target(target)
                ...
                .condition(
                        (unused, requiredParameters) -> {
                            Integer version =
                                    ((VersionParameter) requiredParameters.get(0))
                                            .getSelectedValue();
