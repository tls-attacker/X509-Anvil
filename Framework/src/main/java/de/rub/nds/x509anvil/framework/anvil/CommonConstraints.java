...
public class CommonConstraints {
    ...
    public static <T> FlexibleConditionalConstraint valuesNotAllowedForVersions(List<Integer> restrictedVersions, DerivationScope derivationScope, CertificateSpecificParameter target, List<T> values) {
