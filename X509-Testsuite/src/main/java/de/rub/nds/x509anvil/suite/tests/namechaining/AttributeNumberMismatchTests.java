...
public class AttributeNumberMismatchTests extends X509AnvilTest {
    ...
    private static X509CertificateModifier missingAttributeModifier() {
        return (certificate) -> {
            ...
            RelativeDistinguishedName cnRdn = X509Util.getRdnFromName(subject, X500AttributeType.COMMON_NAME);
    ...
    private static X509CertificateModifier additionalAttributeModifier() {
        return (certificate) -> {
            ...
            RelativeDistinguishedName cnRdn = X509Util.getRdnFromName(issuer, X500AttributeType.COMMON_NAME);
            addAttributeToCn(cnRdn);
        };
    }
    ...
    private static void addAttributeToCn(RelativeDistinguishedName cn) {
        ...
        asn1ObjectIdentifier.setValue(X500AttributeType.COMMON_NAME.getOid().toString());
