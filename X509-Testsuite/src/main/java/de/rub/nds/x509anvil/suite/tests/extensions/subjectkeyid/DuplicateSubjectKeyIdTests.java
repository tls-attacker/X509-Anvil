...
public class DuplicateSubjectKeyIdTests extends X509AnvilTest {
    ...
    @AnvilTest(id = "extension-skid-ddb7cadc32")
    ...
    @AnvilTest(id = "extension-skid-ad98d1b6ce")
    ...
    @ChainLength(minLength = 2)
    @IpmLimitations(identifiers = "entity:extensions_present")
    @AnvilTest(id = "extension-skid-8fc40ac4e1")
    ...
    @ChainLength(minLength = 3)
    @AnvilTest(id = "extension-skid-c9f599cfc7")
    ...
    @ChainLength(minLength = 2)
    @IpmLimitations(identifiers = "entity:extensions_present")
    @AnvilTest(id = "extension-skid-8fc40ac4e2")
    ...
    @ChainLength(minLength = 3)
    @AnvilTest(id = "extension-skid-c9f599cfc8")
