...
public class GeneralizedTimeNonZuluLocalTests extends X509AnvilTest {
    ...
    @AnvilTest(id = "basic-validity-e46824186e")
                ...
                (X509CertificateConfigModifier)
                        config -> {
                            ...
                            config.setDefaultNotBeforeEncoding(
                                    ValidityEncoding.GENERALIZED_TIME_LOCAL);
                        }, testInfo);
    }

    @ChainLength(minLength = 3)
    @IpmLimitations(identifiers = "inter0:not_before")
    @AnvilTest(id = "basic-validity-8706cfabaa")
    ...
    @AnvilTest(id = "basic-validity-f9cadd3fe6")
    ...
    @AnvilTest(id = "basic-validity-3f0d1ca795")
