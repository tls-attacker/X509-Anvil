...
public class ExpiredTests extends X509AnvilTest {
    ...
    public void expiredUtcEntity(X509VerifierRunner testRunner)
    ...
    public void expiredGeneralizedEntity(X509VerifierRunner testRunner)
            throws VerifierException, CertificateGeneratorException {
        assertInvalid(
                testRunner,
                true,
    ...
    public void expiredUtcIntermediate(X509VerifierRunner testRunner)
            throws VerifierException, CertificateGeneratorException {
        assertInvalid(
                testRunner,
                false,
    ...
    public void expiredGeneralizedIntermediate(X509VerifierRunner testRunner)
            throws VerifierException, CertificateGeneratorException {
        assertInvalid(
                testRunner,
                false,
