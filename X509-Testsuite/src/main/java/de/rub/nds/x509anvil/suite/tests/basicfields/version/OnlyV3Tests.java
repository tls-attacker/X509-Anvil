...
public class OnlyV3Tests extends X509AnvilTest {
    ...
    public void v1Entity(X509VerifierRunner testRunner, TestInfo testInfo)
        ...
        assertInvalid(
                testRunner,
                true,
                (X509CertificateConfigModifier) config -> config.setVersion(BigInteger.valueOf(0)), testInfo);
    }
    ...
    public void v2Entity(X509VerifierRunner testRunner, TestInfo testInfo)
        ...
        assertInvalid(
                testRunner,
                true,
                (X509CertificateConfigModifier) config -> config.setVersion(BigInteger.valueOf(1)), testInfo);
    }
