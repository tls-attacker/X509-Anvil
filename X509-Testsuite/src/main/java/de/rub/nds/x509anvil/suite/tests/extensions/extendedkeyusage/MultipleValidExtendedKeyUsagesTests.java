...
public class MultipleValidExtendedKeyUsagesTests extends X509AnvilTest {
    ...
    public void multipleValidExtendedKeyUsagesEntity(X509VerifierRunner testRunner) throws VerifierException, CertificateGeneratorException {
    ...
    public void multipleValidExtendedKeyUsagesIntermediate(X509VerifierRunner testRunner) throws VerifierException, CertificateGeneratorException {
